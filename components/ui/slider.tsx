...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-light-secondary">
      <SliderPrimitive.Range className="absolute h-full bg-light-secondary" />
